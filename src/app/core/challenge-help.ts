...
export const challengeHelp: Record<string, ChallengeHelp> = {
  'get-hello-01': {
    ...
    example: `curl -s ${labApiUrl('/api/hello')}`,
    commentary:
  ...
  'get-users-01': {
    ...
    example: `curl -s ${labApiUrl('/api/users')}`,
    commentary:
  ...
  'header-accept-01': {
    ...
    example: `curl -s -H "Accept: application/json" ${labApiUrl('/api/profile')}`,
    commentary:
  ...
  'header-custom-01': {
    ...
    example: `curl -s -H "X-Lab-Client: curling" ${labApiUrl('/api/lab-client')}`,
    commentary:
  ...
  'query-search-01': {
    ...
    example: `curl -s "${labApiUrl('/api/search?q=stone')}"`,
    commentary:
  ...
  'query-pagination-01': {
    ...
    example: `curl -s "${labApiUrl('/api/search?page=2&limit=5')}"`,
    commentary:
  ...
  'flag-head-01': {
    ...
    example: `curl -I ${labApiUrl('/api/health')}`,
    commentary:
  ...
  'post-login-01': {
    ...
    example: `curl -s -d "user=admin&pass=secret" ${labApiUrl('/api/login')}`,
    commentary:
  ...
  'post-echo-01': {
    ...
    example: `curl -s -d "message=sweep" ${labApiUrl('/api/echo')}`,
    commentary:
  ...
  'post-json-create-01': {
    ...
    example: `curl -s -H "Content-Type: application/json" -d '{"name":"Blue","weight":20}' ${labApiUrl('/api/resources')}`,
    commentary:
  ...
  'post-json-update-01': {
    ...
    example: `curl -s -H "Content-Type: application/json" -d '{"status":"ready"}' ${labApiUrl('/api/echo/json')}`,
    commentary:
  ...
  'put-item-01': {
    ...
    example: `curl -s -X PUT -H "Content-Type: application/json" -d '{"name":"Granite"}' ${labApiUrl('/api/items/7')}`,
    commentary:
  ...
  'patch-item-01': {
    ...
    example: `curl -s -X PATCH -H "Content-Type: application/json" -d '{"weight":42}' ${labApiUrl('/api/items/7')}`,
    commentary:
  ...
  'delete-item-01': {
    ...
    example: `curl -s -X DELETE ${labApiUrl('/api/items/7')}`,
    commentary:
  ...
  'auth-basic-read-01': {
    ...
    example: `curl -s -u curl-lab:rocks ${labApiUrl('/api/secure')}`,
    commentary:
  ...
  'auth-basic-write-01': {
    ...
    example: `curl -s -u curl-lab:rocks -d "note=classified" ${labApiUrl('/api/secure')}`,
    commentary:
  ...
  'auth-bearer-01': {
    ...
    example: `curl -s -H "Authorization: Bearer lab-token-42" ${labApiUrl('/api/admin')}`,
    commentary:
  ...
  'auth-api-key-01': {
    ...
    example: `curl -s -H "X-API-Key: lab-key-99" ${labApiUrl('/api/metrics')}`,
    commentary:
  ...
  'cookie-session-01': {
    ...
    example: `curl -s -b "session=abc123" ${labApiUrl('/api/session/me')}`,
    commentary:
  ...
  'cookie-multi-01': {
    ...
    example: `curl -s -b "session=abc123;theme=dark" ${labApiUrl('/api/session/preferences')}`,
    commentary:
  ...
  'redirect-follow-01': {
    ...
    example: `curl -s -L ${labApiUrl('/api/redirect')}`,
    commentary:
  ...
  'redirect-chain-01': {
    ...
    example: `curl -s -L ${labApiUrl('/api/hop')}`,
    commentary:
  ...
  'meta-user-agent-01': {
    ...
    example: `curl -s -A "CurlingLab/1.0" ${labApiUrl('/api/agent')}`,
    commentary:
  ...
  'meta-referer-01': {
    ...
    example: `curl -s -e "https://curling.lab/docs" ${labApiUrl('/api/referer')}`,
    commentary:
  ...
  'get-data-urlencode-01': {
    ...
    example: `curl -s -G -d "q=hello world" ${labApiUrl('/api/search')}`,
    commentary:
  ...
  'get-data-urlencode-02': {
    ...
    example: `curl -s -G --data-urlencode "status=active" ${labApiUrl('/api/search')}`,
    commentary:
  ...
  'multipart-upload-01': {
    ...
    example: `curl -s -F "photo=sweep.jpg" ${labApiUrl('/api/upload')}`,
    commentary:
  ...
  'multipart-meta-01': {
    ...
    example: `curl -s -F "photo=sweep.jpg" -F "team=skip" ${labApiUrl('/api/upload')}`,
    commentary:
  ...
  'graphql-query-01': {
    ...
    example: `curl -s -H "Content-Type: application/json" -d '{"query":"{ stones }"}' ${labApiUrl('/api/graphql')}`,
    commentary:
  ...
  'graphql-mutation-01': {
    ...
    example: `curl -s -H "Content-Type: application/json" -d '{"query":"mutation { setSkip(name: \\"Nova\\") }"}' ${labApiUrl('/api/graphql')}`,
    commentary:
  ...
  'conditional-etag-01': {
    ...
    example: `curl -s -H 'If-None-Match: "v1"' ${labApiUrl('/api/cache')}`,
    commentary:
  ...
  'conditional-range-01': {
    ...
    example: `curl -s -H "Range: bytes=0-3" ${labApiUrl('/api/range')}`,
    commentary:
  ...
  'perf-max-time-01': {
    ...
    example: `curl -s --max-time 10 ${labApiUrl('/api/slow')}`,
    commentary:
  ...
  'perf-compressed-01': {
    ...
    example: `curl -s --compressed ${labApiUrl('/api/stats')}`,
    commentary:
  ...
  'perf-retry-01': {
    ...
    example: `curl -s --retry 3 ${labApiUrl('/api/flaky')}`,
    commentary:
  ...
  'debug-verbose-01': {
    ...
    example: `curl -v ${labApiUrl('/api/hello')}`,
    commentary:
  ...
  'debug-writeout-01': {
    ...
    example: `curl -s -w "%{http_code}" -o /dev/null ${labApiUrl('/api/hello')}`,
    commentary:
  ...
  'debug-output-01': {
    ...
    example: `curl -s -o hello.json ${labApiUrl('/api/hello')}`,
    commentary:
  ...
  'method-options-01': {
    ...
    example: `curl -s -X OPTIONS ${labApiUrl('/api/resources')}`,
    commentary:
  ...
  'method-proxy-flag-01': {
    ...
    example: `curl -s -x http://proxy.lab:8080 ${labApiUrl('/api/hello')}`,
    commentary:
  ...
  'boss-webhook-01': {
    ...
    example: `curl -s -H "Authorization: Bearer lab-token-42" -H "Content-Type: application/json" -d '{"event":"score"}' ${labApiUrl('/api/webhook')}`,
    commentary:
  ...
  'boss-incident-01': {
    ...
    example: `curl -s -u curl-lab:rocks -b "session=abc123" "${labApiUrl('/api/incident?incident=42')}"`,
    commentary:
  ...
  'boss-pipeline-01': {
    ...
    example: `curl -s -L -X POST -H "Authorization: Bearer lab-token-42" -H "Content-Type: application/json" -d '{"action":"deploy"}' ${labApiUrl('/api/pipeline')}`,
    commentary:
